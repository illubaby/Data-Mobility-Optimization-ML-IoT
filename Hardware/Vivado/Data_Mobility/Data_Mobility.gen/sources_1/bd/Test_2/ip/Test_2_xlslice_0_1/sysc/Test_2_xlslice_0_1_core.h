...
#ifndef _Test_2_xlslice_0_1_core_h_
#define _Test_2_xlslice_0_1_core_h_

#include <systemc.h>
#include "properties.h"


class Test_2_xlslice_0_1_core : public sc_module 
{
    public: 
       Test_2_xlslice_0_1_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , Din    ( "Din" )
              , Dout   ( "Dout" )
    {
        SC_HAS_PROCESS(Test_2_xlslice_0_1_core);
        SC_METHOD(get_slice_value);
        sensitive << Din;

    }

    virtual ~Test_2_xlslice_0_1_core() = default;

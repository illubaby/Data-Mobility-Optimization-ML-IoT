...
#ifndef _gpio_xlconcat_0_0_core_h_
#define _gpio_xlconcat_0_0_core_h_
...
class gpio_xlconcat_0_0_core : public sc_module 
{
    public: 
       gpio_xlconcat_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(gpio_xlconcat_0_0_core);
    ...
    virtual ~gpio_xlconcat_0_0_core() = default;

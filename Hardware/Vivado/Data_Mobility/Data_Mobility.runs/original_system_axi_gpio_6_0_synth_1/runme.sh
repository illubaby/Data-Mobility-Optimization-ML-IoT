...
HD_PWD='C:/Data-Mobility-Optimization-ML-IoT/Hardware/Vivado/Data_Mobility/Data_Mobility.runs/original_system_axi_gpio_6_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log original_system_axi_gpio_6_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source original_system_axi_gpio_6_0.tcl

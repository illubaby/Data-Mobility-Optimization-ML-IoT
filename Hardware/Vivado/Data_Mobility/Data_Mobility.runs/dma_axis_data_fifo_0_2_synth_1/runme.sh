...
HD_PWD='C:/Users/ADMIN/OneDrive/GitHub/FPGA/Data_Mobility/Data_Mobility.runs/dma_axis_data_fifo_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_axis_data_fifo_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_axis_data_fifo_0_2.tcl

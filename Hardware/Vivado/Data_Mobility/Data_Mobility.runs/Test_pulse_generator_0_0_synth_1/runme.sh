...
HD_PWD='C:/Data-Mobility-Optimization-ML-IoT/Hardware/Vivado/Data_Mobility/Data_Mobility.runs/Test_pulse_generator_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_pulse_generator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_pulse_generator_0_0.tcl

...
HD_PWD='C:/Users/ADMIN/OneDrive/GitHub/FPGA/Data_Mobility/Data_Mobility.runs/Test_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_xbar_0.tcl

...
HD_PWD='C:/Data-Mobility-Optimization-ML-IoT/Hardware/Vivado/Data_Mobility/Data_Mobility.runs/Test_DataBufferAxi_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_DataBufferAxi_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_DataBufferAxi_0_1.tcl

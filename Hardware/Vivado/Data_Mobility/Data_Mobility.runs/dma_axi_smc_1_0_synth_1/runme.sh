...
HD_PWD='C:/Users/ADMIN/OneDrive/GitHub/FPGA/Data_Mobility/Data_Mobility.runs/dma_axi_smc_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_axi_smc_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_axi_smc_1_0.tcl

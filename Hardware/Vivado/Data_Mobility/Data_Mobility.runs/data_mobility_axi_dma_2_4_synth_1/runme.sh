...
HD_PWD='C:/Data-Mobility-Optimization-ML-IoT/Hardware/Vivado/Data_Mobility/Data_Mobility.runs/data_mobility_axi_dma_2_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_mobility_axi_dma_2_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_mobility_axi_dma_2_4.tcl

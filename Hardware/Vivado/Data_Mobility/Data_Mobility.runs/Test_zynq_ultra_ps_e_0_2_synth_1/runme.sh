...
HD_PWD='C:/Users/ADMIN/OneDrive/GitHub/FPGA/Data_Mobility/Data_Mobility.runs/Test_zynq_ultra_ps_e_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_zynq_ultra_ps_e_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_zynq_ultra_ps_e_0_2.tcl

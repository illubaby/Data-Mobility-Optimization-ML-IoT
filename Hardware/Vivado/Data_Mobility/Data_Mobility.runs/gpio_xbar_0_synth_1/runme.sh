...
HD_PWD='C:/Users/ADMIN/OneDrive/GitHub/FPGA/Data_Mobility/Data_Mobility.runs/gpio_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_xbar_0.tcl

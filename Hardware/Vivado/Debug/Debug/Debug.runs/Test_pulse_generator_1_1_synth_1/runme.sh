...
HD_PWD='C:/Data-Mobility-Optimization-ML-IoT/Hardware/Vivado/Debug/Debug/Debug.runs/Test_pulse_generator_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_pulse_generator_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_pulse_generator_1_1.tcl

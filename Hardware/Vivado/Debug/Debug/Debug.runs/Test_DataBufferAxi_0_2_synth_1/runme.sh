...
HD_PWD='C:/Data-Mobility-Optimization-ML-IoT/Hardware/Vivado/Debug/Debug/Debug.runs/Test_DataBufferAxi_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_DataBufferAxi_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_DataBufferAxi_0_2.tcl

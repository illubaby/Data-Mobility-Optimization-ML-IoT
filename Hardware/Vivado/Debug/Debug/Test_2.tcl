...
################################################################
# This is a generated script based on design: Test_2
#
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.C_GPIO_WIDTH {1} $axi_gpio_3
  ...
  set_property CONFIG.C_GPIO_WIDTH {1} $axi_gpio_4
  ...
  set_property CONFIG.C_GPIO_WIDTH {1} $axi_gpio_6
...
\
  ...
  set_property CONFIG.C_ALL_OUTPUTS {1} $axi_gpio_8
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins axi_gpio_3/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins ps8_0_axi_periph/M04_AXI] [get_bd_intf_pins axi_gpio_4/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins ps8_0_axi_periph/M05_AXI] [get_bd_intf_pins axi_gpio_5/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M06_AXI [get_bd_intf_pins ps8_0_axi_periph/M06_AXI] [get_bd_intf_pins axi_gpio_6/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M07_AXI [get_bd_intf_pins axi_gpio_7/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M07_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M09_AXI [get_bd_intf_pins ps8_0_axi_periph/M09_AXI] [get_bd_intf_pins axi_gpio_9/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M10_AXI [get_bd_intf_pins ps8_0_axi_periph/M10_AXI] [get_bd_intf_pins axi_gpio_10/S_AXI]
  ...
  connect_bd_net -net al_ultra96v2_0_ifm_waddr [get_bd_pins al_ultra96v2_0/ifm_waddr] [get_bd_pins axi_gpio_9/gpio_io_i] [get_bd_pins ila_0/probe9]
  connect_bd_net -net al_ultra96v2_0_ifm_write_rdy [get_bd_pins al_ultra96v2_0/ifm_write_rdy] [get_bd_pins axi_gpio_10/gpio_io_i] [get_bd_pins ila_0/probe10]
  connect_bd_net -net al_ultra96v2_0_ps_data [get_bd_pins al_ultra96v2_0/ps_data] [get_bd_pins axi_gpio_5/gpio_io_i] [get_bd_pins DataBufferAxi_0/al_ps_data] [get_bd_pins ila_0/probe7]
  connect_bd_net -net al_ultra96v2_0_ps_read_rdy [get_bd_pins al_ultra96v2_0/ps_read_rdy] [get_bd_pins axi_gpio_4/gpio_io_i] [get_bd_pins DataBufferAxi_0/ps_read_rdy] [get_bd_pins ila_0/probe8]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins al_ultra96v2_0/ins_mem_wenb] [get_bd_pins ila_0/probe0]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins al_ultra96v2_0/ins_mem_waddr] [get_bd_pins ila_0/probe1]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins axi_gpio_2/gpio_io_o] [get_bd_pins al_ultra96v2_0/ins_mem_wdata] [get_bd_pins ila_0/probe2]
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_pins axi_gpio_3/gpio_io_o] [get_bd_pins al_ultra96v2_0/enb] [get_bd_pins ila_0/probe6]
  connect_bd_net -net axi_gpio_6_gpio_io_o [get_bd_pins axi_gpio_6/gpio_io_o] [get_bd_pins pulse_generator_0/I]
  connect_bd_net -net axi_gpio_7_gpio_io_o [get_bd_pins axi_gpio_7/gpio_io_o] [get_bd_pins al_ultra96v2_0/ifm_write_fin] [get_bd_pins ila_0/probe4]
  connect_bd_net -net axi_gpio_8_gpio_io_o [get_bd_pins axi_gpio_8/gpio_io_o] [get_bd_pins al_ultra96v2_0/ifm_data] [get_bd_pins ila_0/probe5]
  connect_bd_net -net pulse_generator_0_O [get_bd_pins pulse_generator_0/O] [get_bd_pins al_ultra96v2_0/ps_read_fin] [get_bd_pins ila_0/probe3]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins axi_gpio_5/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins axi_gpio_6/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins DataBufferAxi_0/s00_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins axi_gpio_7/s_axi_aresetn] [get_bd_pins axi_gpio_8/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins axi_gpio_9/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M09_ARESETN] [get_bd_pins axi_gpio_10/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M10_ARESETN] [get_bd_pins ps8_0_axi_periph/M11_ARESETN]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins axi_gpio_5/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins axi_gpio_6/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins al_ultra96v2_0/clk] [get_bd_pins pulse_generator_0/clk] [get_bd_pins DataBufferAxi_0/s00_axi_aclk] [get_bd_pins ps8_0_axi_periph/M07_ACLK] [get_bd_pins axi_gpio_7/s_axi_aclk] [get_bd_pins axi_gpio_8/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M08_ACLK] [get_bd_pins axi_gpio_9/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M09_ACLK] [get_bd_pins axi_gpio_10/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M10_ACLK] [get_bd_pins ps8_0_axi_periph/M11_ACLK] [get_bd_pins ila_0/clk]
  ...
  assign_bd_address -offset 0xA0070000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs DataBufferAxi_0/s00_axi/reg0] -force
  ...
  assign_bd_address -offset 0xA00A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_10/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0xA0090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_9/S_AXI/Reg] -force
